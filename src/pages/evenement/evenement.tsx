...
const EvenementListPage: FC = function () {
  return (
        ...
        <div className="mb-1 w-full">
          <div className="mb-4">
            <Breadcrumb className="mb-4">
              ...
              <Breadcrumb.Item>Evenement</Breadcrumb.Item>
            </Breadcrumb>
  ...
  const ville_event = [
  { id: 1, label: "Lokossa" },
  { id: 2, label: "Malanville" },
  { id: 3, label: "Tanguieta" },
  ];
    ...
    <>
      ...
      <Modal onClose={() => setOpen(false)} show={isOpen}>
        <Modal.Header className="border-b border-gray-200 !p-6 dark:border-gray-700">
          <strong>Ajouter un Evènement</strong>
        </Modal.Header>
        <Modal.Body style={{ overflowY: 'auto', maxHeight: 'calc(100vh - 200px)' }}>
          <form>
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              <div>
                <Label htmlFor="nom_evenement">Evènement</Label>
                <div className="mt-1">
                  <TextInput
                    id="nom_evenement"
                    name="nom_evenement"
              ...
              <div>
                ...
                <div className="mt-1">
                  <TextInput
                    ...
                    name="location"
                    type="text"
                    placeholder="Entrez le lieu de l'event"
                    value={location}
              ...
              <div className="lg:col-span-2">
                <Label htmlFor="ville_event">Ville de l'event</Label>
                <Dropdown
                  id="ville_event"
                  label="Choisissez la ville de l'evenement"
                  dismissOnClick={true}
                  className="lg:col-span-2"
                >
                  {ville_event.map((type) => (
                    <Dropdown.Item key={type.id} className="w-full">
                      <input type="radio" id={`type-${type.id}`} name="ville_event" />
