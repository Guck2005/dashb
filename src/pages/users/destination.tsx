...
const DestinationListPage: FC = function () {
  return (
...
const joursSemaine = ['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi', 'Dimanche'];
  ...
  const typesDestinations = [
  { id: 1, label: "Site touristique" },
  { id: 2, label: "Plage" },
  { id: 3, label: "Musée" },
  ];
const AddDestinationModal: FC = function () {
...
const AllDestinationTable: FC = function () {
  return (
    <Table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600 all-users-table">
      <Table.Head className="bg-gray-100 dark:bg-gray-700">
        ...
        <Table.HeadCell>Type de Destination</Table.HeadCell>
