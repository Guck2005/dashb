...
const PresidentListPage: FC = function () {
  return (
        ...
        <div className="mb-1 w-full">
          <div className="mb-4">
            <Breadcrumb className="mb-4">
              ...
              <Breadcrumb.Item>Présidents</Breadcrumb.Item>
            </Breadcrumb>
            <h1 className="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">
              Historique des Présidents du Bénin
            </h1>
          </div>
...
const AddPresidentModal: FC = function () {
  const [isOpen, setOpen] = useState(false);

  const [mandats, setMandats] = useState([{ debut: '', fin: '' }]); 

  const addMandat = () => {
    const newMandat = { debut: '', fin: '' };
    setMandats(prevMandats => [...prevMandats, newMandat]);
  };
    ...
    <>
      ...
      <Modal onClose={() => setOpen(false)} show={isOpen}>
        <Modal.Header className="border-b border-gray-200 !p-6 dark:border-gray-700">
          <strong>Ajouter un Président</strong>
        </Modal.Header>
        <Modal.Body style={{ overflowY: 'auto', maxHeight: 'calc(100vh - 200px)' }}>
          <form>
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              <div>
                <Button color="primary" onClick={addMandat}>
                  Ajouter une période de mandat
                </Button>
              </div>
                  ...
                  <TextInput
                    ...
                    onChange={(e) => {
                      const updatedMandats = mandats.map((m, i) =>
                        i === index ? { ...m, debut: e.target.value } : m
                      );
              ...
              <div>
                <Label htmlFor="dropdown">Ville d'Origine</Label>
              ...
              <div>
                <Label htmlFor="dropdown">Département</Label>
                <div className="mt-1 w-full">
...
const AllPresidentTable: FC = function () {
  return (
    <Table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600 all-users-table">
      <Table.Head className="bg-gray-100 dark:bg-gray-700">
        ...
        <Table.HeadCell>Président</Table.HeadCell>
        <Table.HeadCell>Ville d'Origine</Table.HeadCell>
        <Table.HeadCell>Période de Mandat</Table.HeadCell>
      ...
      <Table.Body className="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
        ...
        <Table.Row className="hover:bg-gray-100 dark:hover:bg-gray-700">
          ...
          <Table.Cell className="whitespace-nowrap p-4 text-base font-medium text-gray-900 dark:text-white">
              <div className="text-sm font-normal text-gray-500 dark:text-gray-400">
                <div className="text-base font-semibold text-gray-600 dark:text-white">
                  12/03/2563 au 02/03/2563
                </div>
                <div className="text-base font-semibold text-gray-600 dark:text-white">
                  02/03/2563 au 02/03/2563
                </div>
              </div>
          </Table.Cell>
          <Table.Cell>
...
export default PresidentListPage;
